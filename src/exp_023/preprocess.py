...
def create_feature(df_train, df_test):
    ...
    second_feature_blocks = [
        *[KnnLocationDateBlock(agg, n, t, col) for agg in ['mean'] for n in [1, 2, 5, 10] for t in [0.1] for col in ['co_mid', 'no2_mid']],
        *[KnnLocationDateTargetBlock(agg, n, t) for agg in ['mean', 'std'] for n in [3, 5, 10] for t in [0.1]],
